...
class Network(object):
    ...
    def __init__(self, sizes, act_func, act_func_prime):#, weights_file = None): # act_fucn - та функция активации, которую мы подаем нейросети
        ...
        self.target = 0.05 # точность на которую мы желаем обучить нейросеть, на само обучение она никак не влияет, а лишь яв порогом для кол-ва совпадений
...
# гиперболический тангенс и его произоводная (-1, 1)
